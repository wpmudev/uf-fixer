...
"margin_top" => "1", 
"margin_bottom" => "0", 
"id" => "default-post-module-module-module", 
"rows" => 20, 
"options" => array(
	"type" => "ThisPostModel", 
	"view_class" => "ThisPostView", 
	"class" => "c24 c24 c24 c24 upfront-this_post", 
	"has_settings" => 1, 
	"id_slug" => "this_post", 
	"row" => 10, 
...
"margin_top" => "0", 
"margin_bottom" => "0", 
"id" => "default-comment-module-module-module", 
"rows" => 10, 
"options" => array(
	"id_slug" => "ucomment", 
	"type" => "UcommentModel", 
	"view_class" => "UcommentView", 
	"class" => "c24 c24 c24 c24 upfront-comment", 
	"has_settings" => 0, 
