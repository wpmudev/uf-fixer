...
"options" => array(
	...
	"menu_items" => array(array(
			"menu-item-db-id" => 3673,
			"menu-item-parent-id" => "0",
			"menu-item-type" => "custom",
			"menu-item-title" => "Service",
			"menu-item-url" => "#service",
			"menu-item-object" => "custom",
			"menu-item-object-id" => "3673",
			"menu-item-target" => "",
			"menu-item-position" => 1
			), array(
			"menu-item-db-id" => 3674,
			"menu-item-parent-id" => "0",
			"menu-item-type" => "custom",
			"menu-item-title" => "Get a Quote",
			"menu-item-url" => "#getquote",
			"menu-item-object" => "custom",
			"menu-item-object-id" => "3674",
			"menu-item-target" => "",
			"menu-item-position" => 2
			), array(
			"menu-item-db-id" => 3675,
			"menu-item-parent-id" => "0",
			"menu-item-type" => "custom",
			"menu-item-title" => "Blog",
			"menu-item-url" => "#blog",
			"menu-item-object" => "custom",
			"menu-item-object-id" => "3675",
			"menu-item-target" => "",
			"menu-item-position" => 3
			), array(
			"menu-item-db-id" => 3676,
			"menu-item-parent-id" => "0",
			"menu-item-type" => "custom",
			"menu-item-title" => "About",
			"menu-item-url" => "#about",
			"menu-item-object" => "custom",
			"menu-item-object-id" => "3676",
			"menu-item-target" => "",
			"menu-item-position" => 4
			), array(
			"menu-item-db-id" => 3677,
			"menu-item-parent-id" => "0",
			"menu-item-type" => "custom",
			"menu-item-title" => "Coverage Area",
			"menu-item-url" => "#coveragearea",
			"menu-item-object" => "custom",
			"menu-item-object-id" => "3677",
			"menu-item-target" => "",
