...
"background_slider_images" => array("/images/slider-b.jpg", "/images/slider-a.jpg", "/images/slider-c.jpg", "/images/slider-d.jpg", "/images/slider-e.jpg"), 
"background_style" => "full", 
"background_position_y" => "50", 
"background_position_x" => "50", 
"use_padding" => 0, 
...
"options" => array(
	...
	"menu_items" => array(array(
			...
			"sub" => array(array(
					"menu-item-db-id" => 24, 
					"menu-item-parent-id" => "23", 
					"menu-item-type" => "custom", 
					"menu-item-title" => "dddddd", 
					"menu-item-url" => "#ltb-sdf8", 
					"menu-item-object" => "custom", 
			...
			"menu-item-url" => "" . get_site_url() . "/store/", 
			"menu-item-object" => "custom", 
			...
			"sub" => array(array(
					"menu-item-db-id" => 172, 
					"menu-item-parent-id" => "171", 
					"menu-item-type" => "custom", 
					"menu-item-title" => "Products", 
					"menu-item-url" => "" . get_site_url() . "/store/products/", 
					"menu-item-object" => "custom", 
					...
					"menu-item-parent-id" => "171", 
					"menu-item-type" => "custom", 
					"menu-item-title" => "Shopping Cart", 
					"menu-item-url" => "" . get_site_url() . "/store/shopping-cart/", 
					"menu-item-object" => "custom", 
					...
					"menu-item-url" => "" . get_site_url() . "/store/order-status/", 
					"menu-item-object" => "custom", 
...
if (file_exists(get_stylesheet_directory() . DIRECTORY_SEPARATOR . 'global-regions' . DIRECTORY_SEPARATOR . 'lightboxes' . DIRECTORY_SEPARATOR . 'ltb-sdf8.php')) include(get_stylesheet_directory() . DIRECTORY_SEPARATOR . 'global-regions' . DIRECTORY_SEPARATOR . 'lightboxes' . DIRECTORY_SEPARATOR . 'ltb-sdf8.php');
