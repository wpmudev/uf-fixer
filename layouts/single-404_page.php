...
"options" => array(
	...
	"id_slug" => "plain_text", 
	"content" => "<h1 style=\"text-align: start;\" class=\"\">Page&nbsp;not</h1><h1 style=\"text-align: start;\" class=\"\">available but</h1><h1 style=\"text-align: start;\" class=\"\">Mr Fixer</h1><h1 style=\"text-align: start;\" class=\"\">is.</h1>", 
	"type" => "PlainTxtModel", 
