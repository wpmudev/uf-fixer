...
"rows" => 10, 
"options" => array(
	"src" => "" . get_stylesheet_directory_uri() . "/images/single-page/fixer-logo-white-100x20-3868-100x20-8648.png", 
	"srcFull" => "" . get_stylesheet_directory_uri() . "/images/single-page/fixer-logo-white-100x20-3868.png", 
	"srcOriginal" => "" . get_stylesheet_directory_uri() . "/images/single-page/fixer-logo-white-100x20-3868.png", 
	"image_title" => "", 
	"alternative_text" => "", 
	"when_clicked" => false, 
	"image_link" => "", 
